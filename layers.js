...
var lyr_kebun_3 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'kebun<br />\
    <img src="styles/legend/kebun_3_0.png" /> <br />'
        });
...
var lyr_lapangan_4 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'lapangan<br />\
    <img src="styles/legend/lapangan_4_0.png" /> <br />'
        });
...
var lyr_jalan_6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'jalan<br />\
    <img src="styles/legend/jalan_6_0.png" /> 2<br />\
    <img src="styles/legend/jalan_6_1.png" /> 3<br />\
    <img src="styles/legend/jalan_6_2.png" /> 4<br />\
    <img src="styles/legend/jalan_6_3.png" /> 8<br />\
    <img src="styles/legend/jalan_6_4.png" /> <br />'
        });
...
var lyr_Clipped_7 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Clipped<br />\
    <img src="styles/legend/Clipped_7_0.png" /> residential<br />\
    <img src="styles/legend/Clipped_7_1.png" /> service<br />\
    <img src="styles/legend/Clipped_7_2.png" /> trunk<br />\
    <img src="styles/legend/Clipped_7_3.png" /> unclassified<br />\
    <img src="styles/legend/Clipped_7_4.png" /> <br />'
        });
...
var lyr_Point_10 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Point<br />\
    <img src="styles/legend/Point_10_0.png" /> <br />\
    <img src="styles/legend/Point_10_1.png" /> bengkel<br />\
    <img src="styles/legend/Point_10_2.png" /> cf<br />\
    <img src="styles/legend/Point_10_3.png" /> instansi<br />\
    <img src="styles/legend/Point_10_4.png" /> instasi<br />\
    <img src="styles/legend/Point_10_5.png" /> kep<br />\
    <img src="styles/legend/Point_10_6.png" /> kes<br />\
    <img src="styles/legend/Point_10_7.png" /> mart<br />\
    <img src="styles/legend/Point_10_8.png" /> Mart<br />\
    <img src="styles/legend/Point_10_9.png" /> pend<br />\
    <img src="styles/legend/Point_10_10.png" /> pom<br />\
    <img src="styles/legend/Point_10_11.png" /> rm<br />\
    <img src="styles/legend/Point_10_12.png" /> tb<br />\
    <img src="styles/legend/Point_10_13.png" /> ti<br />\
    <img src="styles/legend/Point_10_14.png" /> UMKM<br />\
    <img src="styles/legend/Point_10_15.png" /> wir<br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_gadm41_IDNADM_ADM_4_1.setVisible(true);lyr_RW_2.setVisible(true);lyr_kebun_3.setVisible(true);lyr_lapangan_4.setVisible(true);lyr_irigasi_5.setVisible(true);lyr_jalan_6.setVisible(true);lyr_Clipped_7.setVisible(true);lyr_makam_8.setVisible(true);lyr_Clipped_9.setVisible(true);lyr_Point_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_gadm41_IDNADM_ADM_4_1,lyr_RW_2,lyr_kebun_3,lyr_lapangan_4,lyr_irigasi_5,lyr_jalan_6,lyr_Clipped_7,lyr_makam_8,lyr_Clipped_9,lyr_Point_10];
...
lyr_kebun_3.set('fieldAliases', {'id': 'id', });
...
lyr_kebun_3.set('fieldImages', {'id': 'TextEdit', });
...
lyr_Clipped_7.set('fieldImages', {'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'depth': 'TextEdit', 'railway': 'TextEdit', 'blockage': 'TextEdit', 'amenity': 'TextEdit', 'name': 'TextEdit', 'width': 'TextEdit', 'public_tra': 'TextEdit', 'bridge': 'TextEdit', 'smoothness': 'TextEdit', 'landuse': 'TextEdit', 'covered': 'TextEdit', 'diameter': 'TextEdit', 'aeroway': 'TextEdit', 'waterway': 'TextEdit', 'parking': 'TextEdit', 'tunnel': 'TextEdit', 'building': 'TextEdit', 'operator': 'TextEdit', 'barrier': 'TextEdit', 'capacity': 'TextEdit', 'man_made': 'TextEdit', 'water': 'TextEdit', 'highway': 'TextEdit', 'surface': 'TextEdit', 'pump': 'TextEdit', 'oneway': 'TextEdit', 'layer': 'TextEdit', 'natural': 'TextEdit', });
lyr_makam_8.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', });
lyr_Clipped_9.set('fieldImages', {'osm_id': '', 'osm_type': '', 'addr_stree': '', 'access_roo': '', 'building_m': '', 'building': '', 'isced_leve': '', 'roof_mater': '', 'capacity': '', 'amenity': '', 'name': '', 'emergency': '', 'addr_house': '', });
lyr_Point_10.set('fieldImages', {'id': 'TextEdit', 'Kel': 'TextEdit', 'Nama': 'TextEdit', });
...
lyr_kebun_3.set('fieldLabels', {'id': 'no label', });
lyr_lapangan_4.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', });
lyr_irigasi_5.set('fieldLabels', {'id': 'no label', });
lyr_jalan_6.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', 'lebar': 'inline label - visible with data', });
lyr_Clipped_7.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'depth': 'no label', 'railway': 'no label', 'blockage': 'no label', 'amenity': 'no label', 'name': 'no label', 'width': 'no label', 'public_tra': 'no label', 'bridge': 'no label', 'smoothness': 'no label', 'landuse': 'no label', 'covered': 'no label', 'diameter': 'no label', 'aeroway': 'no label', 'waterway': 'no label', 'parking': 'no label', 'tunnel': 'no label', 'building': 'no label', 'operator': 'no label', 'barrier': 'no label', 'capacity': 'no label', 'man_made': 'no label', 'water': 'no label', 'highway': 'no label', 'surface': 'no label', 'pump': 'no label', 'oneway': 'no label', 'layer': 'no label', 'natural': 'no label', });
lyr_makam_8.set('fieldLabels', {'id': 'no label', 'Nama': 'inline label - visible with data', });
lyr_Clipped_9.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'addr_stree': 'no label', 'access_roo': 'no label', 'building_m': 'no label', 'building': 'no label', 'isced_leve': 'no label', 'roof_mater': 'no label', 'capacity': 'no label', 'amenity': 'no label', 'name': 'no label', 'emergency': 'no label', 'addr_house': 'no label', });
lyr_Point_10.set('fieldLabels', {'id': 'no label', 'Kel': 'no label', 'Nama': 'inline label - always visible', });
